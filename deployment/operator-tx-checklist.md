...
and requires the four broadcast responses to have distinct 64-character hex tx
hashes and nondecreasing heights in launch order: create pair, provide liquidity,
direct tiny swap, then router tiny swap.
