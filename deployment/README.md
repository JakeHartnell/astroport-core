...
also rejects reused tx hashes, failed tx codes, unchanged post-swap pool state,
and out-of-order tx heights across create pair → provide liquidity → direct tiny
swap → router tiny swap.
