...
export const openApiDocument = {
  ...
  servers: [{ url: "/" }],
  paths: {
    "/health": { get: ok({ type: "object", properties: { status: { type: "string", const: "ok" }, service: { type: "string" }, chainId: { type: "string" }, cursorHeight: { type: ["number", "null"] }, headHeight: { type: ["number", "null"] }, lag: { type: ["number", "null"] }, rpcReachable: { type: "boolean" }, dataSource: { type: "string", const: "indexer" }, isMock: { type: "boolean", const: false } } }) },
